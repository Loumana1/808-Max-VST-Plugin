...
const var btnPitchUp = Content.getComponent("btnWaveformPitchup");
const var btnPitchDown = Content.getComponent("btnWaveformPitchDown");
const var  PitchModule= Synth.getModulator("Pitch control");

btnPitchDown.set("processorId", "Pitch control");
btnPitchDown.set("parameterId" , "intensity");

btnPitchUp.set("processorId", "Pitch control");
btnPitchUp.set("parameterId" , "intensity");


// Pitch Up Button (+12)
inline function onbtnPitchUpControl(component, value)
{
    if (value)
    {
       // btnPitchup.setValu( 1);
        PitchModule.setAttribute(Intensity, 12);
        
    }
    else
    {
        btnPitchUp.setValue(0);
    }
}

// Pitch Down Button (-12)
inline function onbtnPitchDownControl(component, value)
{
    if (value)
    {

        // btnPitchDown.setValue( 1);
         PitchModule.setAttribute(Intensity, -12);
        
    }
    else
    {
         btnPitchDown.setValue( 0);
    }
*/
// Set up the control callbacks
//btnPitchUp.setControlCallback(onbtnPitchUpControl);
//btnPitchDown.setControlCallback(onbtnPitchDownControl);