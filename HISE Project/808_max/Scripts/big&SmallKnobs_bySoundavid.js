...
const bigSmallKnobLAF = Content.createLocalLookAndFeel();

bigSmallKnobLAF.registerFunction("drawRotarySlider", function(g, obj)
{
	var a = obj.area;
	var thick = 3;
	var thick2 = 2;
	...
	if (obj.text.indexOf("big") != -1)
	{
		...
		start = 2;
		 end = start * 2 * obj.valueNormalized - start;
